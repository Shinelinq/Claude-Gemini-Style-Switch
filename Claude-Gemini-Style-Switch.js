...
// @version      1.4.0
// @description  v1.4.0: 完整组件样式覆盖（按钮/输入框/卡片/侧边栏/消息气泡增强）+ 修复切换按钮定位问题
...
(function () {
  ...
  const GLOBAL_STYLES = `
    body, html, bard-app, chat-app, main, .app-container, .main-container {
      background: var(--claude-bg) !important;
      background-color: var(--claude-bg) !important;
      color: var(--claude-text) !important;
    }
    .top-bar-actions, .gb_T, header, mat-toolbar, .mat-toolbar {
  ...
  const SIDEBAR_STYLES = `
    bard-sidenav, side-navigation-v2, .side-nav-menu-button, .conversations-list-container, .sidenav-container, mat-sidenav, .mat-drawer {
      background: var(--claude-bg-secondary) !important;
      background-color: var(--claude-bg-secondary) !important;
    }
    .side-nav-action-button, .conversation, .conversation-item, .nav-item {
    ...
    .side-nav-action-button:hover, .conversation:hover, .conversation-item:hover, .nav-item:hover {
      background: var(--claude-bg-tertiary) !important;
      background-color: var(--claude-bg-tertiary) !important;
      transform: translateX(4px) !important;
    }
    .conversation.selected, .conversation-item.selected, .nav-item.active {
      background: var(--claude-bg-tertiary) !important;
      background-color: var(--claude-bg-tertiary) !important;
  ...
  const CHAT_STYLES = `
    .chat-container, .chat-history, .chat-history-scroll-container, .conversation-container {
      background: var(--claude-bg) !important;
      background-color: var(--claude-bg) !important;
      padding: 24px !important;
    }
    .message-content, message-content, .model-response-text, .user-query, .response-container {
      background: white !important;
      background-color: white !important;
    ...
    .model-response-text, .response-text {
  ...
  const INPUT_STYLES = `
    .input-area-container, .text-input-container, .input-container {
      background: white !important;
      background-color: white !important;
    ...
    .input-area-container:focus-within, .text-input-container:focus-within, .input-container:focus-within {
    ...
    .text-input-field, .ql-editor, .input-field, textarea.mat-input-element {
      background: transparent !important;
      background-color: transparent !important;
      color: var(--claude-text) !important;
  ...
  const BUTTON_STYLES = `
    .mat-mdc-button, .mat-mdc-unelevated-button, .mat-mdc-raised-button, button[mat-button], button[mat-raised-button], button[mat-flat-button] {
    ...
    .mat-mdc-button:hover, .mat-mdc-unelevated-button:hover, .mat-mdc-raised-button:hover, button[mat-button]:hover {
    ...
    .send-button, button[aria-label*="Send"], button[aria-label*="发送"] {
      background: var(--claude-primary) !important;
      background-color: var(--claude-primary) !important;
    ...
    .send-button:hover:not([aria-disabled="true"]), button[aria-label*="Send"]:hover:not([disabled]) {
      background: var(--claude-primary-dark) !important;
      background-color: var(--claude-primary-dark) !important;
      transform: scale(1.1) !important;
    }
    .send-button[aria-disabled="true"], .send-button[disabled], button[disabled] {
      background: var(--claude-border) !important;
      background-color: var(--claude-border) !important;
      opacity: 0.5 !important;
      cursor: not-allowed !important;
    }
    .upload-button, .toolbox-drawer-button, .speech_dictation_mic_button, button[aria-label*="Upload"], button[aria-label*="上传"] {
      background: transparent !important;
      background-color: transparent !important;
      border: 1px solid var(--claude-border) !important;
      border-radius: 10px !important;
    ...
    .upload-button:hover, .toolbox-drawer-button:hover, .speech_dictation_mic_button:hover {
      background: var(--claude-bg-tertiary) !important;
      background-color: var(--claude-bg-tertiary) !important;
      border-color: var(--claude-primary) !important;
    }
  ...
  const CARD_STYLES = `
    .intent-card, .card, intent-card, mat-card, .mat-card {
      background: white !important;
      background-color: white !important;
      border: 2px solid var(--claude-border) !important;
    ...
    .intent-card:hover, .card:hover, mat-card:hover, .mat-card:hover {
      border-color: var(--claude-primary) !important;
      box-shadow: 0 6px 16px var(--claude-shadow-md) !important;
      transform: translateY(-4px) scale(1.02) !important;
    }
    .card-label, .mat-card-title {
      font-weight: 600 !important;
      color: var(--claude-text) !important;
    }
  `;
  ...
  const MISC_STYLES = `
    a { color: var(--claude-primary) !important; text-decoration: none !important; transition: color 0.2s ease !important; }
    a:hover { color: var(--claude-primary-dark) !important; text-decoration: underline !important; }
    mat-icon, .material-icons, .google-symbols { color: var(--claude-text-muted) !important; transition: color 0.2s ease !important; }
    .mat-mdc-button mat-icon, .send-button mat-icon, button mat-icon { color: white !important; }
    ::-webkit-scrollbar { width: 10px !important; height: 10px !important; }
    ::-webkit-scrollbar-track { background: var(--claude-bg-secondary) !important; border-radius: 5px !important; }
    ::-webkit-scrollbar-thumb { background: var(--claude-primary) !important; border-radius: 5px !important; border: 2px solid var(--claude-bg-secondary) !important; }
    ...
    *:focus-visible { outline: 2px solid var(--claude-primary) !important; outline-offset: 2px !important; border-radius: 4px !important; }
  `;
  ...
  function applyStyles() {
    if (!mainStyleElement) {
      ...
      mainStyleElement.id = 'claude-main-styles';
      mainStyleElement.textContent = MAIN_STYLES;
      (document.head || document.documentElement).appendChild(mainStyleElement);
  ...
  function applyButtonStyles() {
    if (!buttonStyleElement) {
      ...
      buttonStyleElement.id = 'claude-button-styles';
      buttonStyleElement.textContent = TOGGLE_BUTTON_STYLES;
      (document.head || document.documentElement).appendChild(buttonStyleElement);
    }
  }
